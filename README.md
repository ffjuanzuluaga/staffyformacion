...
| Vendido / Cierre Staff | Oportunidades **ganadas** (`won_status=won`): Σ `expected_revenue` por mes de **`create_date`** de la oportunidad (igual que CRM → Fecha de creación). No usa OV ni MRR |
...
| Cierre vs. meta | Staff: opp ganadas; Formación/Fábrica: OV vs. `meta_anual / 12` |
| Cursos/proyectos vendidos | Oportunidades `won_status=won` por **`create_date`** |
