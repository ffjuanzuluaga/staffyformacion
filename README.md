...
| Vendido Staff | Σ `recurring_monthly` de `sale.order` suscripciones con **`first_contract_date`** en el mes (igual que Odoo → Suscripciones). Fallback: `firefly.staffing.request.date_start` |
