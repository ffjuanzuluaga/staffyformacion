...
| Vendido Staff | `firefly.staffing.request`: `monthly_amount_company_currency` × meses de vigencia en el año (suscripción recurrente). Fallback: `sale.order.recurring_monthly` |
