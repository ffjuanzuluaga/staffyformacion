...
| Vendido Staff (KPI anual) | Valor suscripción × plan recurrente: `recurring_monthly` × meses vigentes en el año (plan mensual). Fuente: `sale.order` suscripciones Staff |
